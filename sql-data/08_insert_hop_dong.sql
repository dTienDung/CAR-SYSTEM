...
('HD-20231213-0008',
 ...
 (SELECT id FROM ho_so_tham_dinh WHERE ma_hs = 'HS-20231213-0008'),
 (SELECT id FROM goi_bao_hiem WHERE ma_goi = 'GOI003'),
 '2023-12-13', '2023-12-18', '2024-12-17', 8000000.00, 8000000.00,
 'DANG_HIEU_LUC', 'Hợp đồng xe Fortuner của khách hàng thân thiết',
 (SELECT id FROM users WHERE username = 'sales'),
 NULL, NULL,
 '2023-12-13 17:00:00', '2023-12-18 11:00:00'),

('HD-20231215-0009',
 (SELECT id FROM khach_hang WHERE ma_kh = 'KH000008'),
 (SELECT id FROM xe WHERE ma_xe = 'XE000009'),
 (SELECT id FROM ho_so_tham_dinh WHERE ma_hs = 'HS-20231215-0009'),
 (SELECT id FROM goi_bao_hiem WHERE ma_goi = 'GOI002'),
 '2023-12-15', '2023-12-20', '2024-12-19', 6000000.00, 6000000.00,
 'DANG_HIEU_LUC', 'Hợp đồng xe Vinfast Fadil',
 (SELECT id FROM users WHERE username = 'sales'),
 NULL, NULL,
 '2023-12-15 15:00:00', '2023-12-20 09:30:00'),

('HD-20231218-0010',
 (SELECT id FROM khach_hang WHERE ma_kh = 'KH000009'),
 (SELECT id FROM xe WHERE ma_xe = 'XE000010'),
 (SELECT id FROM ho_so_tham_dinh WHERE ma_hs = 'HS-20231218-0010'),
 (SELECT id FROM goi_bao_hiem WHERE ma_goi = 'GOI003'),
 '2023-12-18', '2023-12-22', '2024-12-21', 8000000.00, 8000000.00,
 'DANG_HIEU_LUC', 'Hợp đồng xe Honda CR-V',
 (SELECT id FROM users WHERE username = 'sales'),
 NULL, NULL,
 '2023-12-18 16:30:00', '2023-12-22 10:00:00'),

('HD-20240105-0011',
 (SELECT id FROM khach_hang WHERE ma_kh = 'KH000010'),
 (SELECT id FROM xe WHERE ma_xe = 'XE000011'),
 (SELECT id FROM ho_so_tham_dinh WHERE ma_hs = 'HS-20240105-0015'),
 (SELECT id FROM goi_bao_hiem WHERE ma_goi = 'GOI002'),
 '2024-01-05', '2024-01-10', '2025-01-09', 6000000.00, 6000000.00,
 'DANG_HIEU_LUC', 'Hợp đồng mới năm 2024',
 (SELECT id FROM users WHERE username = 'sales'),
 NULL, NULL,
